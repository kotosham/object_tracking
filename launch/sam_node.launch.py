...
def launch_setup(context, *args, **kwargs):
    ...
    cmd = [
        ...
        '-p',
        f"search_failures_before_rotation:={LaunchConfiguration('search_failures_before_rotation').perform(context)}",
        '-p',
        f"search_rotation_duration_s:={LaunchConfiguration('search_rotation_duration_s').perform(context)}",
        '-p',
        f"search_settle_time_s:={LaunchConfiguration('search_settle_time_s').perform(context)}",
        '-p',
        f"search_max_rotation_steps:={LaunchConfiguration('search_max_rotation_steps').perform(context)}",
        '-p',
        ...
        '-p',
        f"dino_selection_policy:={LaunchConfiguration('dino_selection_policy').perform(context)}",
        '-p',
        f"dino_center_weight:={LaunchConfiguration('dino_center_weight').perform(context)}",
        '-p',
        f"dino_max_center_distance_norm:={LaunchConfiguration('dino_max_center_distance_norm').perform(context)}",
        '-p',
        f"dino_max_center_x_offset_norm:={LaunchConfiguration('dino_max_center_x_offset_norm').perform(context)}",
        '-p',
        f"dino_max_center_y_offset_norm:={LaunchConfiguration('dino_max_center_y_offset_norm').perform(context)}",
        '-p',
