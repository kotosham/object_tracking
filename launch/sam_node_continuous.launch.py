...
def generate_launch_description():
    ...
    depth_relay_topic = LaunchConfiguration('depth_relay_topic')
    ...
    depth_republish = Node(
        ...
        name='republish_tracker_depth_compressed',
        output='screen',
        parameters=[{
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            description='Base depth topic name before image_transport decompression.',
        ),
        DeclareLaunchArgument(
            'depth_image_transport',
            default_value='compressedDepth',
            description='Depth image_transport used on the incoming camera stream.',
        ),
        DeclareLaunchArgument(
            'depth_relay_topic',
            default_value='/tracker/aligned_depth_to_color/image_raw',
            description='Local raw depth relay topic produced for the continuous tracker.',
        ),
        DeclareLaunchArgument(
            'prompt_topic',
